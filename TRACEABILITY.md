...
| TR-02 | C1 | 2 | 2 | inferred | PRD Makalah Ceritas + objektif drv roadmap | Sinteisis asisten -> PRD | Roadmap + pengetahuan umum | PRD mencakup RISE | Tinggi | baca extracted/C1.json msg2 (kepala) |
...
| TR-04 | C1 | 4 | 4 | inferred | TASK_BREAKDOWN.md modular diserahkan | Checklist + good-first-issue | PRD C1 | File tersimpan di root | Tinggi | baca extracted/C1.json msg4 (kepala) |
...
| TR-06 | C1 | 6 | 6 | inferred | 7 Tahapan Sistematik + Tahap 0 stack | Staged Prompting | Contoh Next.js | Dokumen tahapan | Tinggi | baca extracted/C1.json msg6 (kepala) |
...
| TR-10 | C1 | 20 | 20 | inferred | File makalah METs + references.bib | Penulisan + BibTeX | Konten METs | Siap compile | Tinggi | baca extracted/C1.json msg20 (kepala) |
| TR-11 | C1 | 24 | 24 | inferred | Kompilasi Elsevier 17 hlm sukses | pdflatex+bibtex | ecrc/elsarticle | 17 hlm, elemen lengkap | Tinggi | kompilasi ulang pdflatex; cek visual PDF |
...
| TR-13 | C1 | 26 | 26 | inferred | File presentasi Beamer diserahkan | Beamer | Isi makalah | Compile 2x pdflatex | Tinggi | baca extracted/C1.json msg26 (kepala); kompilasi ulang |
...
| TR-15 | C1 | 30 | 30 | inferred | Skip aplikasi web (Next.js/Prisma) | Keputusan skope | TIDAK_TERSEDIA | Keputusan tercatat | Tinggi | baca extracted/C1.json msg30 (kepala) |
...
| TR-36 | C1 | 110 | 116 | inferred | Hasil: 94 ok, 31 gagal | Audit hasil unduh | Folder referensi/ + gagal.txt | 94/31/skip | Tinggi | audit folder referensi/ + gagal.txt |
...
| TR-44 | C1 | 170 | 178 | inferred | Tabel jadi 1 sisi via table* | table* full-width | Tabel 1-2 | Tak tindih | Tinggi | kompilasi ulang; cek visual tabel |
| TR-45 | C1 | 176 | 184 | inferred | IEEE = layout terbaik | Evaluasi template | Makalah 20 hlm | Keputusan tercatat | Tinggi | baca extracted/C1.json msg176 (kepala) |
...
| TR-51 | C2 | 5 | 9 | inferred | Tempel tex final + pindah NIM->nama | Iterasi judul IEEE | ieee_final.tex pengguna | File acuan | Tinggi | baca extracted/C2.json msg5 (parsial, 70KB) |
...
| TR-55 | C3 | 2 | 2 | inferred | File .tex IEEE lengkap diserahkan | Aplikasi konten ke template | docx | documentclass-end lengkap | Sedang | baca extracted/C3.json msg2 (kepala); kompilasi |
...
| TR-57 | C4 | 2 | 2 | inferred | Laporan layout + versi terkoreksi | Audit format IEEE | ieee.tex | Bold em-dash dkk | Sedang | baca extracted/C4.json msg2 (kepala); cek visual |
...
- Total: **69 TR** (≥40 terpenuhi). Perincian status: confirmed=54, inferred=13, conflicting=2.
